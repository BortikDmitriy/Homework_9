public class MyHashMap<K, V> {
    ...
    // Метод для изменения размера таблицы при необходимости
    @SuppressWarnings("unchecked")
    private void resize() {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Size: " + map.size()); // Должно напечатать 3
        System.out.println("Value for key 2: " + map.get(2)); // Должно напечатать "Two"

        map.remove(2);
        System.out.println("Size after removal: " + map.size()); // Должно напечатать 2
